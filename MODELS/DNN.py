...
np.savetxt('DNN_label.csv',t,delimiter=',')
...
class DNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.linear = nn.Linear(self.embedding_dim*50 , label_num)
    ...
    def forward(self, x):
        ...
        x = x.view(-1, self.embedding_dim*50)
...
def testcalc_metrics1(data_iter, net,epoch):
    ...
    data1.to_csv('DNN'+str(epoch)+'.csv')
